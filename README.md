...
npx sv@0.15.4 create --template minimal --types ts --add prettier eslint sveltekit-adapter="adapter:auto" drizzle="database:sqlite+sqlite:better-sqlite3" better-auth="demo:password" --install npm ./
```
